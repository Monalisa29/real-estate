          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">                
                ...
                <li><a href="">DECONECTEAZA-TE</a></li>                                        
              </ul>
            </li>
          </ul>                            
        </div><!--/.nav-collapse -->       
      ...
      <row>
        <div class="col-md-12">
          <div class="aa-error-area">
            <h2>404</h2>
            <p><span class="fa fa-warning"></span>Oops! A aparut o eroare. Incercati mai tarziu.</p>
            <a href="index.jsp">Inapoi Acasa</a>
          </div>
        </div>
      </row>
    </div>
